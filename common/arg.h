...
struct common_arg {
    std::set<enum lhm_example> examples = {LHM_EXAMPLE_COMMON};
    std::set<enum lhm_example> excludes = {};
    ...
    common_arg & set_examples(std::initializer_list<enum lhm_example> examples);
    common_arg & set_excludes(std::initializer_list<enum lhm_example> excludes);
    common_arg & set_env(const char * env);
    common_arg & set_sampling();
    common_arg & set_spec();
    common_arg & set_preset_only();
    bool in_example(enum lhm_example ex);
    bool is_exclude(enum lhm_example ex);
...
struct common_params_context {
    enum lhm_example ex = LHM_EXAMPLE_COMMON;
...
bool common_params_parse(int argc, char ** argv, common_params & params, lhm_example ex, void(*print_usage)(int, char **) = nullptr);
...
common_params_context common_params_parser_init(common_params & params, lhm_example ex, void(*print_usage)(int, char **) = nullptr);
