...
DECLARE_string(webui_config);
DECLARE_string(ui_config);
DECLARE_string(webui_config_file);
DECLARE_string(ui_config_file);
DECLARE_bool(webui_mcp_proxy);
DECLARE_bool(ui_mcp_proxy);
...
DECLARE_string(media_path);
DECLARE_string(models_dir);
DECLARE_string(models_preset);
DECLARE_int32(models_max);
DECLARE_bool(models_autoload);
DECLARE_bool(jinja);
