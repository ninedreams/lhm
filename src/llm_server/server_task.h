...
// TODO: prevent including the whole server_common.h as we only use server_tokens
...
// TODO: change this to more generic "response_format" to replace the "format_response_*" in server_common
...
struct task_params {
    ...
    json format_logit_bias(const std::vector<lhm_logit_bias> & logit_bias) const;
...
struct server_prompt_cache {
    ...
    bool load(server_prompt & prompt, const server_tokens & tokens_new, lhm_context * ctx_main, lhm_context * ctx_drft, int32_t id_slot);
