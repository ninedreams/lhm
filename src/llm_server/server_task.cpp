...
json task_params::format_logit_bias(const std::vector<lhm_logit_bias> & logit_bias) const {
...
bool server_prompt_cache::load(server_prompt & prompt, const server_tokens & tokens_new, lhm_context * ctx_tgt, lhm_context * ctx_dft, int32_t id_slot) {
