...
struct quantize_state_impl {
    ...
    quantize_state_impl(const lhm_model & model, const lhm_model_quantize_params * params):
...
static void lhm_tensor_dequantize_impl(
...
static bool tensor_allows_quantization(const lhm_model_quantize_params * params, llm_arch arch, const ggml_tensor * tensor) {
...
static ggml_type lhm_tensor_get_type_impl(quantize_state_impl & qs, ggml_type new_type, const ggml_tensor * tensor, lhm_ftype ftype, tensor_category category) {
    const std::string name = ggml_get_name(tensor);
    ...
    if (category == tensor_category::OUTPUT || (qs.has_tied_embeddings && category == tensor_category::TOKEN_EMBD)) {
        if (qs.params->output_tensor_type < GGML_TYPE_COUNT) {
            ...
            if (ftype == LHM_FTYPE_MOSTLY_MXFP4_MOE) {
                new_type = GGML_TYPE_Q8_0;
            }
            else if (nx % qk_k != 0) {
                new_type = GGML_TYPE_Q8_0;
            }
            else if (ftype == LHM_FTYPE_MOSTLY_IQ2_XXS || ftype == LHM_FTYPE_MOSTLY_IQ2_XS || ftype == LHM_FTYPE_MOSTLY_IQ3_XXS ||
                     ftype == LHM_FTYPE_MOSTLY_IQ1_S   || ftype == LHM_FTYPE_MOSTLY_IQ2_S  || ftype == LHM_FTYPE_MOSTLY_IQ2_M   ||
                     ftype == LHM_FTYPE_MOSTLY_IQ1_M) {
    ...
    } else if (ftype == LHM_FTYPE_MOSTLY_MXFP4_MOE) {
        // MoE   tensors -> MXFP4
        // other tensors -> Q8_0
        if (tensor->ne[2] > 1) {
        ...
        if (qs.params->token_embedding_type < GGML_TYPE_COUNT) {
            ...
            if (ftype == LHM_FTYPE_MOSTLY_IQ2_XXS || ftype == LHM_FTYPE_MOSTLY_IQ2_XS ||
                ftype == LHM_FTYPE_MOSTLY_IQ1_S   || ftype == LHM_FTYPE_MOSTLY_IQ1_M) {
                new_type = GGML_TYPE_Q2_K;
            }
            else if (ftype == LHM_FTYPE_MOSTLY_IQ2_S || ftype == LHM_FTYPE_MOSTLY_IQ2_M) {
                new_type = GGML_TYPE_IQ3_S;
            }
            else if (ftype == LHM_FTYPE_MOSTLY_IQ3_XXS) {
                new_type = GGML_TYPE_IQ3_S;
            }
            else if (ftype == LHM_FTYPE_MOSTLY_TQ1_0 || ftype == LHM_FTYPE_MOSTLY_TQ2_0) {
                new_type = GGML_TYPE_Q4_K;
            }
        }
    } else if (ftype == LHM_FTYPE_MOSTLY_IQ2_XXS || ftype == LHM_FTYPE_MOSTLY_IQ2_XS || ftype == LHM_FTYPE_MOSTLY_IQ1_S ||
               ftype == LHM_FTYPE_MOSTLY_IQ2_S || ftype == LHM_FTYPE_MOSTLY_IQ2_M    || ftype == LHM_FTYPE_MOSTLY_IQ1_M) {
        if (category_is_attn_v(category)) {
            if (qs.model.hparams.n_gqa() >= 4 || qs.model.hparams.n_expert >= 4) new_type = GGML_TYPE_Q4_K;
            else new_type = ftype == LHM_FTYPE_MOSTLY_IQ2_S || ftype == LHM_FTYPE_MOSTLY_IQ2_M ? GGML_TYPE_IQ3_S : GGML_TYPE_Q2_K;
            ++qs.i_attention_wv;
        }
            ...
            if (qs.i_ffn_down < qs.n_ffn_down/8) {
                new_type = ftype == LHM_FTYPE_MOSTLY_IQ2_S || ftype == LHM_FTYPE_MOSTLY_IQ2_M ? GGML_TYPE_IQ3_S : GGML_TYPE_Q2_K;
            }
            ++qs.i_ffn_down;
        }
            ...
            if (qs.model.hparams.n_expert == 8) {
                ...
                if (ftype == LHM_FTYPE_MOSTLY_IQ1_S || ftype == LHM_FTYPE_MOSTLY_IQ1_M) new_type = GGML_TYPE_IQ2_XXS;
                else if (ftype == LHM_FTYPE_MOSTLY_IQ2_S || ftype == LHM_FTYPE_MOSTLY_IQ2_M) new_type = GGML_TYPE_IQ3_S;
            }
        }
    } else if (category_is_attn_v(category)) {
        if      (ftype == LHM_FTYPE_MOSTLY_Q2_K) {
            new_type = qs.model.hparams.n_gqa() >= 4 ? GGML_TYPE_Q4_K : GGML_TYPE_Q3_K;
        }
        else if (ftype == LHM_FTYPE_MOSTLY_Q2_K_S && qs.model.hparams.n_gqa() >= 4) {
            new_type = GGML_TYPE_Q4_K;
        }
        else if (ftype == LHM_FTYPE_MOSTLY_IQ3_XXS) {
            new_type = qs.model.hparams.n_gqa() >= 4 ? GGML_TYPE_Q4_K : !qs.has_imatrix ? GGML_TYPE_IQ3_S : GGML_TYPE_IQ3_XXS;
        }
        else if ((ftype == LHM_FTYPE_MOSTLY_IQ3_XS || ftype == LHM_FTYPE_MOSTLY_IQ3_S) && qs.model.hparams.n_gqa() >= 4) {
            new_type = GGML_TYPE_Q4_K;
        }
        else if (ftype == LHM_FTYPE_MOSTLY_IQ3_M) {
            new_type = GGML_TYPE_Q4_K;
        }
        else if (ftype == LHM_FTYPE_MOSTLY_Q3_K_M) {
            new_type = qs.i_attention_wv < 2 ? GGML_TYPE_Q5_K : GGML_TYPE_Q4_K;
        }
        else if (ftype == LHM_FTYPE_MOSTLY_Q3_K_L) new_type = GGML_TYPE_Q5_K;
        else if ((ftype == LHM_FTYPE_MOSTLY_IQ4_NL || ftype == LHM_FTYPE_MOSTLY_IQ4_XS) && qs.model.hparams.n_gqa() >= 4) {
            new_type = GGML_TYPE_Q5_K;
        }
        else if ((ftype == LHM_FTYPE_MOSTLY_Q4_K_M || ftype == LHM_FTYPE_MOSTLY_Q5_K_M) &&
                use_more_bits(qs.i_attention_wv, qs.n_attention_wv)) new_type = GGML_TYPE_Q6_K;
        else if (ftype == LHM_FTYPE_MOSTLY_Q4_K_S && qs.i_attention_wv < 4) new_type = GGML_TYPE_Q5_K;
        ...
        else if (ftype == LHM_FTYPE_MOSTLY_IQ3_XS) {
        ...
        if (ftype == LHM_FTYPE_MOSTLY_IQ3_XS) {
            new_type = GGML_TYPE_IQ3_XXS;
        }
        else if (ftype == LHM_FTYPE_MOSTLY_IQ3_XXS) {
            new_type = GGML_TYPE_IQ2_S;
        ...
        if      (ftype == LHM_FTYPE_MOSTLY_Q2_K) new_type = GGML_TYPE_Q3_K;
        else if (ftype == LHM_FTYPE_MOSTLY_Q2_K_S) {
            if (i_layer < n_layer/8) new_type = GGML_TYPE_Q4_K;
        }
        else if (ftype == LHM_FTYPE_MOSTLY_IQ3_XXS && !qs.has_imatrix) {
        ...
        else if (ftype == LHM_FTYPE_MOSTLY_IQ3_M && (i_layer < n_layer/8 ||
                    (qs.model.hparams.n_expert == 8 && use_more_bits(i_layer, n_layer)))) {
            new_type = GGML_TYPE_Q4_K;
        }
        else if (ftype == LHM_FTYPE_MOSTLY_Q3_K_L) {
            new_type = GGML_TYPE_Q5_K;
        }
        else if (ftype == LHM_FTYPE_MOSTLY_Q4_K_M) {
            if (use_more_bits(i_layer, n_layer)) new_type = GGML_TYPE_Q6_K;
        }
        else if (i_layer < n_layer/8 && (ftype == LHM_FTYPE_MOSTLY_IQ4_NL || ftype == LHM_FTYPE_MOSTLY_IQ4_XS) && !qs.has_imatrix) {
            new_type = GGML_TYPE_Q5_K;
        }
        else if (ftype == LHM_FTYPE_MOSTLY_Q5_K_M && use_more_bits(i_layer, n_layer)) new_type = GGML_TYPE_Q6_K;
        else if (ftype == LHM_FTYPE_MOSTLY_Q4_K_S && i_layer < n_layer/8) {
            new_type = GGML_TYPE_Q5_K;
        }
        else if ((ftype == LHM_FTYPE_MOSTLY_Q4_0 || ftype == LHM_FTYPE_MOSTLY_Q5_0)
                && qs.has_imatrix && i_layer < n_layer/8) {
            // Guard against craziness in the first few ffn_down layers that can happen even with imatrix for Q4_0/Q5_0.
            // We only do it when an imatrix is provided because a) we want to make sure that one can always get the
            // same quantization as before imatrix stuff, and b) Q4_1/Q5_1 do go crazy on ffn_down without an imatrix.
            new_type = ftype == LHM_FTYPE_MOSTLY_Q4_0 ? GGML_TYPE_Q4_1 : GGML_TYPE_Q5_1;
        }
        ++qs.i_ffn_down;
    } else if (category == tensor_category::ATTENTION_OUTPUT) {
            if (qs.model.hparams.n_expert == 8) {
                if (ftype == LHM_FTYPE_MOSTLY_Q2_K   || ftype == LHM_FTYPE_MOSTLY_IQ3_XS || ftype == LHM_FTYPE_MOSTLY_IQ3_XXS ||
                    ftype == LHM_FTYPE_MOSTLY_Q3_K_S || ftype == LHM_FTYPE_MOSTLY_Q3_K_M  || ftype == LHM_FTYPE_MOSTLY_IQ4_NL  ||
                    ftype == LHM_FTYPE_MOSTLY_Q4_K_S || ftype == LHM_FTYPE_MOSTLY_Q4_K_M  || ftype == LHM_FTYPE_MOSTLY_IQ3_S  ||
                    ftype == LHM_FTYPE_MOSTLY_IQ3_M  || ftype == LHM_FTYPE_MOSTLY_IQ4_XS) {
                    new_type = GGML_TYPE_Q5_K;
                }
            } else {
                if      (ftype == LHM_FTYPE_MOSTLY_Q2_K   ) new_type = GGML_TYPE_Q3_K;
                else if (ftype == LHM_FTYPE_MOSTLY_IQ3_XXS) new_type = GGML_TYPE_IQ3_S;
                else if (ftype == LHM_FTYPE_MOSTLY_Q3_K_M ) new_type = GGML_TYPE_Q4_K;
                else if (ftype == LHM_FTYPE_MOSTLY_Q3_K_L ) new_type = GGML_TYPE_Q5_K;
                else if (ftype == LHM_FTYPE_MOSTLY_IQ3_M  ) new_type = GGML_TYPE_Q4_K;
            }
    }
    else if (category == tensor_category::ATTENTION_QKV) {
        if (ftype == LHM_FTYPE_MOSTLY_Q3_K_M || ftype == LHM_FTYPE_MOSTLY_Q3_K_L || ftype == LHM_FTYPE_MOSTLY_IQ3_M) {
            new_type = GGML_TYPE_Q4_K;
        }
        else if (ftype == LHM_FTYPE_MOSTLY_Q4_K_M) new_type = GGML_TYPE_Q5_K;
        else if (ftype == LHM_FTYPE_MOSTLY_Q5_K_M) new_type = GGML_TYPE_Q6_K;
    }
    else if (category == tensor_category::FFN_GATE) {
        auto info = layer_info(qs.i_ffn_gate, qs.n_ffn_gate, name.c_str());
        int i_layer = info.first, n_layer = info.second;
        if (ftype == LHM_FTYPE_MOSTLY_IQ3_XS && (i_layer >= n_layer/8 && i_layer < 7*n_layer/8)) {
            new_type = GGML_TYPE_IQ3_XXS;
        }
        ++qs.i_ffn_gate;
    }
...
static ggml_type lhm_tensor_get_type(quantize_state_impl & qs, const lhm_model_quantize_params * params, const ggml_tensor * tensor, ggml_type default_type, const tensor_metadata & tm) {
    ...
    if (!params->pure && ggml_is_quantized(default_type)) {
        ...
        if (!manual) {
            new_type = lhm_tensor_get_type_impl(qs, new_type, tensor, params->ftype, tm.category);
        }
...
static size_t lhm_tensor_quantize_impl(enum ggml_type new_type, const float * f32_data, void * new_data, const int64_t chunk_size, int64_t nrows, int64_t n_per_row, const float * imatrix, std::vector<std::thread> & workers, const int nthread) {
    if (nthread < 2) {
        // single-thread
...
static bool tensor_requires_imatrix(const char * tensor_name, const ggml_type dst_type, const lhm_ftype ftype) {
    ...
    switch (dst_type) {
        ...
        case GGML_TYPE_Q2_K:
            ...
            return ftype == LHM_FTYPE_MOSTLY_Q2_K_S;
        default:
            return false;
    }
}
...
ggml_type lhm_ftype_get_default_type(lhm_ftype ftype) {
    switch (ftype) {
        case LHM_FTYPE_MOSTLY_Q4_0: return GGML_TYPE_Q4_0;
        case LHM_FTYPE_MOSTLY_Q4_1: return GGML_TYPE_Q4_1;
        case LHM_FTYPE_MOSTLY_Q5_0: return GGML_TYPE_Q5_0;
        case LHM_FTYPE_MOSTLY_Q5_1: return GGML_TYPE_Q5_1;
        case LHM_FTYPE_MOSTLY_Q8_0: return GGML_TYPE_Q8_0;
        case LHM_FTYPE_MOSTLY_F16:  return GGML_TYPE_F16;
        case LHM_FTYPE_MOSTLY_BF16: return GGML_TYPE_BF16;
        case LHM_FTYPE_ALL_F32:     return GGML_TYPE_F32;
        case LHM_FTYPE_MOSTLY_Q1_0: return GGML_TYPE_Q1_0;

        case LHM_FTYPE_MOSTLY_MXFP4_MOE: return GGML_TYPE_MXFP4;

        // K-quants
        case LHM_FTYPE_MOSTLY_Q2_K_S:
        case LHM_FTYPE_MOSTLY_Q2_K:    return GGML_TYPE_Q2_K;
        case LHM_FTYPE_MOSTLY_IQ3_XS:  return GGML_TYPE_IQ3_S;
        case LHM_FTYPE_MOSTLY_Q3_K_S:
        case LHM_FTYPE_MOSTLY_Q3_K_M:
        case LHM_FTYPE_MOSTLY_Q3_K_L:  return GGML_TYPE_Q3_K;
        case LHM_FTYPE_MOSTLY_Q4_K_S:
        case LHM_FTYPE_MOSTLY_Q4_K_M:  return GGML_TYPE_Q4_K;
        case LHM_FTYPE_MOSTLY_Q5_K_S:
        case LHM_FTYPE_MOSTLY_Q5_K_M:  return GGML_TYPE_Q5_K;
        case LHM_FTYPE_MOSTLY_Q6_K:    return GGML_TYPE_Q6_K;
        case LHM_FTYPE_MOSTLY_TQ1_0:   return GGML_TYPE_TQ1_0;
        case LHM_FTYPE_MOSTLY_TQ2_0:   return GGML_TYPE_TQ2_0;
        case LHM_FTYPE_MOSTLY_IQ2_XXS: return GGML_TYPE_IQ2_XXS;
        case LHM_FTYPE_MOSTLY_IQ2_XS:  return GGML_TYPE_IQ2_XS;
        case LHM_FTYPE_MOSTLY_IQ2_S:   return GGML_TYPE_IQ2_XS;
        case LHM_FTYPE_MOSTLY_IQ2_M:   return GGML_TYPE_IQ2_S;
        case LHM_FTYPE_MOSTLY_IQ3_XXS: return GGML_TYPE_IQ3_XXS;
        case LHM_FTYPE_MOSTLY_IQ1_S:   return GGML_TYPE_IQ1_S;
        case LHM_FTYPE_MOSTLY_IQ1_M:   return GGML_TYPE_IQ1_M;
        case LHM_FTYPE_MOSTLY_IQ4_NL:  return GGML_TYPE_IQ4_NL;
        case LHM_FTYPE_MOSTLY_IQ4_XS:  return GGML_TYPE_IQ4_XS;
        case LHM_FTYPE_MOSTLY_IQ3_S:
        case LHM_FTYPE_MOSTLY_IQ3_M:   return GGML_TYPE_IQ3_S;
...
static void lhm_model_quantize_impl(const std::string & fname_inp, const std::string & fname_out, const lhm_model_quantize_params * params) {
    lhm_ftype ftype = params->ftype;
    ...
    const lhm_model_kv_override * kv_overrides = params->kv_overrides;
    std::vector<std::string> splits = {};
    lhm_model_loader ml(/*metadata*/ nullptr, /*set_tensor_data*/ nullptr, /*set_tensor_data_ud*/ nullptr,
    ...
    std::unique_ptr<lhm_model> model_ptr(lhm_model_create(ml, mparams));
    ...
    if (params->imatrix) {
        for (const lhm_model_imatrix_data * p = params->imatrix; p->name != nullptr; p++) {
    ...
    if (params->kv_overrides) {
        for (const lhm_model_kv_override * o = params->kv_overrides; o->key[0] != 0; ++o) {
            if (o->tag == LHM_KV_OVERRIDE_TYPE_FLOAT) {
                gguf_set_val_f32(ctx_out.get(), o->key, o->val_f64);
            } else if (o->tag == LHM_KV_OVERRIDE_TYPE_INT) {
                // Setting type to UINT32. See https://github.com/ggml-org/lhm.cpp/pull/14182 for context
                gguf_set_val_u32(ctx_out.get(), o->key, (uint32_t)std::abs(o->val_i64));
            } else if (o->tag == LHM_KV_OVERRIDE_TYPE_BOOL) {
    ...
    std::vector<const lhm_model_loader::lhm_tensor_weight *> tensors;
    ...
    if (params->keep_split) {
        std::sort(tensors.begin(), tensors.end(), [](const lhm_model_loader::lhm_tensor_weight * a, const lhm_model_loader::lhm_tensor_weight * b) {
            if (a->idx == b->idx) {
    ...
    for (size_t i = 0; i < tensors.size(); ++i) {
        ...
        if (metadata[i].allows_quantization) {
            metadata[i].target_type = lhm_tensor_get_type(qs, params, tensor, default_type, metadata[i]);
        } else {
    ...
    auto new_ofstream = [&](int index) {
        ...
        if (params->keep_split) {
            ...
            lhm_split_path(split_path.data(), split_path.size(), fname_out.c_str(), cur_split, n_split);
...
lhm_model_quantize_params lhm_model_quantize_default_params() {
    lhm_model_quantize_params result = {
        /*.nthread                     =*/ 0,
        /*.ftype                       =*/ LHM_FTYPE_MOSTLY_Q8_0,
...
//
// Helper functions for external tools exposed in lhm_ext.h
//
...
lhm_model * lhm_quant_model_from_metadata(const lhm_quant_model_desc * desc) {
    struct lhm_model_params mparams = lhm_model_default_params();
    auto arch = llm_arch_from_string(desc->architecture);
    auto * model = lhm_model_create(arch, mparams);
    model->arch = arch;
...
void lhm_quant_compute_types(
    ...
    lhm_model_quantize_params local_params = *qs->params;
    ...
    // compute types
    for (size_t i = 0; i < n_tensors; i++) {
        result_types[i] = lhm_tensor_get_type(*qs, &local_params, tensors[i], default_type, metadata[i]);
    }
}
