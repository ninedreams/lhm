...
// TODO Do not use prefixes, do not append weights at the end; write the full key directly.
// like: blk.%d.attn_sinks.weight
// This coding approach does not realize code reusability; on the contrary, it reduces readability.
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_MTP_HC_HEAD_BASE,                       "mtp.%d.hc_head_base" },
    { LLM_TENSOR_MTP_HC_HEAD_FN,                         "mtp.%d.hc_head_fn" },
    { LLM_TENSOR_MTP_HC_HEAD_SCALE,                      "mtp.%d.hc_head_scale" },
    { LLM_TENSOR_MTP_E_PROJ,                             "mtp.%d.e_proj" },
    { LLM_TENSOR_MTP_H_PROJ,                             "mtp.%d.h_proj" },
    { LLM_TENSOR_MTP_ENORM,                              "mtp.%d.e_norm" },
    { LLM_TENSOR_MTP_HNORM,                              "mtp.%d.h_norm" },
    { LLM_TENSOR_MTP_NORM,                               "mtp.%d.norm" },
    { LLM_TENSOR_MTP_HC_ATTN_FN,                         "mtp.%d.hc_attn_fn" },
    { LLM_TENSOR_MTP_HC_ATTN_SCALE,                      "mtp.%d.hc_attn_scale" },
    { LLM_TENSOR_MTP_HC_ATTN_BASE,                       "mtp.%d.hc_attn_base" },
    { LLM_TENSOR_MTP_ATTN_NORM,                          "mtp.%d.attn_norm" },
    { LLM_TENSOR_MTP_ATTN_Q_A,                           "mtp.%d.attn_q_a" },
    { LLM_TENSOR_MTP_ATTN_Q_A_NORM,                      "mtp.%d.attn_q_a_norm" },
    { LLM_TENSOR_MTP_ATTN_Q_B,                           "mtp.%d.attn_q_b" },
    { LLM_TENSOR_MTP_ATTN_KV,                            "mtp.%d.attn_kv" },
    { LLM_TENSOR_MTP_ATTN_KV_A_NORM,                     "mtp.%d.attn_kv_a_norm" },
    { LLM_TENSOR_MTP_ATTN_SINKS,                         "mtp.%d.attn_sinks" },
    { LLM_TENSOR_MTP_ATTN_OUTPUT_A,                      "mtp.%d.attn_output_a" },
    { LLM_TENSOR_MTP_ATTN_OUTPUT_B,                      "mtp.%d.attn_output_b" },
    { LLM_TENSOR_MTP_HC_FFN_FN,                          "mtp.%d.hc_ffn_fn" },
    { LLM_TENSOR_MTP_HC_FFN_SCALE,                       "mtp.%d.hc_ffn_scale" },
    { LLM_TENSOR_MTP_HC_FFN_BASE,                        "mtp.%d.hc_ffn_base" },
    { LLM_TENSOR_MTP_FFN_NORM,                           "mtp.%d.ffn_norm" },
    { LLM_TENSOR_MTP_FFN_GATE_INP,                       "mtp.%d.ffn_gate_inp" },
    { LLM_TENSOR_MTP_FFN_EXP_PROBS_B,                    "mtp.%d.ffn_exp_probs_b" },
    { LLM_TENSOR_MTP_FFN_GATE_EXPS,                      "mtp.%d.ffn_gate_exps" },
    { LLM_TENSOR_MTP_FFN_UP_EXPS,                        "mtp.%d.ffn_up_exps" },
    { LLM_TENSOR_MTP_FFN_DOWN_EXPS,                      "mtp.%d.ffn_down_exps" },
    { LLM_TENSOR_MTP_FFN_GATE_SHEXP,                     "mtp.%d.ffn_gate_shexp" },
    { LLM_TENSOR_MTP_FFN_UP_SHEXP,                       "mtp.%d.ffn_up_shexp" },
    { LLM_TENSOR_MTP_FFN_DOWN_SHEXP,                     "mtp.%d.ffn_down_shexp" }
};
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_MTP_ENORM, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_MTP_HNORM, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_MTP_NORM, {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL}},
    {LLM_TENSOR_MTP_HC_ATTN_FN, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_HC_ATTN_SCALE, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_MTP_HC_ATTN_BASE, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_ADD}},
    {LLM_TENSOR_MTP_HC_FFN_FN, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_HC_FFN_SCALE, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_MTP_HC_FFN_BASE, {LLM_TENSOR_LAYER_REPEATING,    GGML_OP_ADD}},
    {LLM_TENSOR_MTP_ATTN_NORM, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_ATTN_Q_A, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_ATTN_Q_A_NORM, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_ATTN_Q_B, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_ATTN_KV, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_ATTN_KV_A_NORM, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_ATTN_SINKS, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_ATTN_OUTPUT_A, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_ATTN_OUTPUT_B, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_FFN_NORM, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_FFN_GATE_INP, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_FFN_EXP_PROBS_B, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_FFN_GATE_EXPS, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_FFN_UP_EXPS, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_FFN_DOWN_EXPS, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_FFN_GATE_SHEXP, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_FFN_UP_SHEXP, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_FFN_DOWN_SHEXP, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}}
};
