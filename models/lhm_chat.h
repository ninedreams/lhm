...
enum llm_chat_template {
    ...
    LLM_CHAT_TEMPLATE_LHM_2,
    LLM_CHAT_TEMPLATE_LHM_2_SYS,
    LLM_CHAT_TEMPLATE_LHM_2_SYS_BOS,
    LLM_CHAT_TEMPLATE_LHM_2_SYS_STRIP,
