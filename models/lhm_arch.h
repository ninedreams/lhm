...
// TODO too much kv enums, different models may have different kvs, need to unify them?
enum llm_kv {
    LLM_KV_GENERAL_TYPE,
...
enum llm_tensor {
    ...
    LLM_TENSOR_MTP_NORM,
    LLM_TENSOR_MTP_HC_ATTN_FN,
    LLM_TENSOR_MTP_HC_ATTN_SCALE,
    LLM_TENSOR_MTP_HC_ATTN_BASE,
    LLM_TENSOR_MTP_ATTN_NORM,
    LLM_TENSOR_MTP_ATTN_Q_A,
    LLM_TENSOR_MTP_ATTN_Q_A_NORM,
    LLM_TENSOR_MTP_ATTN_Q_B,
    LLM_TENSOR_MTP_ATTN_KV,
    LLM_TENSOR_MTP_ATTN_KV_A_NORM,
    LLM_TENSOR_MTP_ATTN_SINKS,
    LLM_TENSOR_MTP_ATTN_OUTPUT_A,
    LLM_TENSOR_MTP_ATTN_OUTPUT_B,
    LLM_TENSOR_MTP_HC_FFN_FN,
    LLM_TENSOR_MTP_HC_FFN_SCALE,
    LLM_TENSOR_MTP_HC_FFN_BASE,
    LLM_TENSOR_MTP_FFN_NORM,
    LLM_TENSOR_MTP_FFN_GATE_INP,
    LLM_TENSOR_MTP_FFN_EXP_PROBS_B,
    LLM_TENSOR_MTP_FFN_GATE_EXPS,
    LLM_TENSOR_MTP_FFN_UP_EXPS,
    LLM_TENSOR_MTP_FFN_DOWN_EXPS,
    LLM_TENSOR_MTP_FFN_GATE_SHEXP,
    LLM_TENSOR_MTP_FFN_UP_SHEXP,
    LLM_TENSOR_MTP_FFN_DOWN_SHEXP
};
